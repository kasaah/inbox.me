...
namespace GenderPredictor {
    ...
    public partial class feedbackDataSet : global::System.Data.DataSet {
        ...
        public partial class commentDataTable : global::System.Data.TypedTableBase<commentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public commentRow AddcommentRow(string name, string email, string comment) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public commentRow FindByname(string name) {
...
namespace GenderPredictor.feedbackDataSetTableAdapters {
    ...
    public partial class commentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[comment] WHERE (([name] = @Original_name) AND ((@IsNull_email " +
                "= 1 AND [email] IS NULL) OR ([email] = @Original_email)) AND ([comment] = @Origi" +
                "nal_comment))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[comment] ([name], [email], [comment]) VALUES (@name, @email, @" +
                "comment);\r\nSELECT name, email, comment FROM comment WHERE (name = @name)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[comment] SET [name] = @name, [email] = @email, [comment] = @comment WHERE (([name] = @Original_name) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)) AND ([comment] = @Original_comment));
SELECT name, email, comment FROM comment WHERE (name = @name)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::GenderPredictor.Properties.Settings.Default.feedbackConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT name, email, comment FROM dbo.comment";
        ...
        public virtual int Fill(feedbackDataSet.commentDataTable dataTable) {
        ...
        public virtual feedbackDataSet.commentDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            feedbackDataSet.commentDataTable dataTable = new feedbackDataSet.commentDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(feedbackDataSet.commentDataTable dataTable) {
        ...
        public virtual int Delete(string Original_name, string Original_email, string Original_comment) {
        ...
        public virtual int Insert(string name, string email, string comment) {
            if ((name == null)) {
        ...
        public virtual int Update(string name, string email, string comment, string Original_name, string Original_email, string Original_comment) {
            if ((name == null)) {
                throw new global::System.ArgumentNullException("name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string email, string comment, string Original_name, string Original_email, string Original_comment) {
            return this.Update(Original_name, email, comment, Original_name, Original_email, Original_comment);
        }
    }
